        ...
        <View>
          ...
          <View style={styles.descriptionview}>
            <Text style={styles.description}>
              Interactive features mirror the traditional classroom
              experience and learners receive feedback to increase
              long-term retention, stripling learning efficacy over standard
              video.
            </Text>
          </View>
